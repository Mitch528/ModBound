...
{
    public class RegisterViewModel : MBViewModel
    {
        ...
        public async Task<RegisterResponse> Register(string username, string password, string email)
        {

            var resp = await ModBoundApi.RegisterAsync(username, password, email);
